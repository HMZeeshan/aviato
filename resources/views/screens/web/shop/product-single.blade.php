					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								...
								<div class='item'>
									<img src='{{asset('assets/web/images/shop/single-products/product-4.jpg')}}' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
								<div class='item'>
							...
							<div class="post-comments">
						    	<ul class="media-list comments-list m-bot-50 clearlist">
								    ...
								    <li class="media">
								        ...
								        <a class="pull-left" href="#!">
								            <img class="media-object comment-avatar" src="{{asset('assets/web/images/blog/avater-4.jpg')}}" alt="" width="50" height="50" />
								        </a>
